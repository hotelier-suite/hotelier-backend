...
import { BeverageInventoryService } from './';
import { RESTAURANT_SERVICE_CLIENT } from '../constants';

describe('BeverageInventoryService (gateway)', () => {
  ...
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        ...
        { provide: RESTAURANT_SERVICE_CLIENT, useValue: mockClient },
      ],
    }).compile();
    service = module.get<BeverageInventoryService>(BeverageInventoryService);
    jest.clearAllMocks();
  });
