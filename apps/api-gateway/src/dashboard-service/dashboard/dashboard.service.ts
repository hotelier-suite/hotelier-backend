...
export class DashboardService {
  ...
  createWidget(data: CreateDashboardWidgetDto): Observable<DashboardWidgetDto> {
    return this.dashboardClient.send<DashboardWidgetDto, CreateDashboardWidgetDto>(
      WIDGETS_PATTERNS.CREATE,
      data,
    );
  }

  findAllWidgets(): Observable<DashboardWidgetDto[]> {
    return this.dashboardClient.send<DashboardWidgetDto[], Record<string, never>>(
  ...
  updateWidget(id: number, data: UpdateDashboardWidgetDto): Observable<DashboardWidgetDto> {
    return this.dashboardClient.send<DashboardWidgetDto, { id: number; data: UpdateDashboardWidgetDto }>(
      WIDGETS_PATTERNS.UPDATE,
      { id, data },
    );
  }
  ...
  getTopPerformingRooms(): Observable<TopPerformingRoomDto[]> {
    return this.dashboardClient.send<TopPerformingRoomDto[], Record<string, never>>(
